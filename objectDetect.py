...
cap.set(10, 160) # for brightness
cap.set(3, 1920) # for width
cap.set(4, 1080) # for height
...
while(True) :
    ...
    img, conts = utils.getContours(img, minArea=45000, filter=4)
    ...
    if(len(conts) != 0):
        ...
        if(len(conts) != 0):
            for obj in conts2:
                ...
                cv2.arrowedLine(imgContours2, (nPoints[0][0][0], nPoints[0][0][1]), (nPoints[1][0][0], nPoints[2][0][0]),
                                (255, 0, 255), 3, 8, 0, 0.05)
                cv2.arrowedLine(imgContours2, (nPoints[0][0][0], nPoints[0][0][1]), (nPoints[2][0][0], nPoints[1][0][0]),
                                (255, 0, 255), 3, 8, 0, 0.05)
                x,y,w,h = obj[3]
